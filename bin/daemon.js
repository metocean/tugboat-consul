...
var Tugboat, Watch, consulhost, fatalerror, hascontainers, host, http, key, launch, needsupdate, os, parse_url, path, series, temperrors, url;
      ...
      return tugboat.diff(function(err, results) {
        ...
        tasks.push(function(cb) {
          if (groupstoupdate.length === 0 && groupstocull.length === 0) {
            ...
            return console.log("Tugboat changes complete");
          }
        });
